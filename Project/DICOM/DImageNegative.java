...
public class DImageNegative extends JFrame
{
	Container     c;
	...
	JButton       jbtnReset,jbtnSave,jbtnNegative;
	JTabbedPane   jtp;
	JTextArea	  jta;
    
     final Image img;
	 DImageNegative app1;
	public DImageNegative(Image image)
	{ 
	    super();
		...
		jbtnNegative = new JButton("NEGATIVE");
		jbtnNegative.setBounds(600,650,100,25);
		...
		jbtnSave.addActionListener(new ActionListener()
		{
			...
			int returnVal = fcc.showDialog(app1,"Save");
				...
				saveJPG(DImageEnhancer.mBufferedImage,filex);
				}
			}
		});
		
		jbtnNegative.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
