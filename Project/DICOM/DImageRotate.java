...
public class DImageRotate extends JFrame
{
	...
	JButton       jbtnReset,jbtnSave,jbtn90,jbtn180;
	JTabbedPane   jtp;
	JTextArea	  jta;
    
     final Image img;
	 DImageNegative app1;
	public DImageRotate(Image image)
	{ 
	    super();
		...
		jbtn90= new JButton("ROTATE 90");
		jbtn90.setBounds(600,650,100,25);
		
		jbtn180= new JButton("ROTATE 180");
		jbtn180.setBounds(750,650,100,25);
		...
		jbtn90.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
		...
		jbtn180.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
