...
public class DImageContrast extends JFrame
{
	Container     c;
	...
	JButton       jbtnReset,jbtnSave,jbtnBright;
	JTabbedPane   jtp;
	JTextArea	  jta;
    
     final Image img;
	 DImageContrast app1;
	public DImageContrast(Image image)
	{ 
	    super();
		...
		jbtnBright = new JButton("BRIGHT");
		jbtnBright.setBounds(600,650,100,25);
		...
		jbtnBright.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
