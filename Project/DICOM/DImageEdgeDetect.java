...
public class DImageEdgeDetect extends JFrame
{
	Container     c;
	...
	JButton       jbtnReset,jbtnSave,jbtnEdge;
	JTabbedPane   jtp;
	JTextArea	  jta;
    
     final Image img;
	 DImageNegative app1;
	public DImageEdgeDetect(Image image)
	{ 
	    super();
		...
		jbtnEdge = new JButton("EDGE DETECT");
		jbtnEdge.setBounds(600,650,100,25);
		...
		jbtnEdge.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
